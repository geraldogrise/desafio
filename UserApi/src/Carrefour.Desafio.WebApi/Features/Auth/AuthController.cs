...
using Carrefour.Desafio.WebApi.Features.Auth.AuthenticateUserFeature;
using Carrefour.Desafio.Application.Auth.AuthenticateUser;

namespace Carrefour.Desafio.WebApi.Features.Auth;
